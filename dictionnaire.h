 ...
 * sont des directives à destination du pré-processeur, une étape réalisée avant
 * la compilation. Ces lignes permettent d'éviter d'inclure plusieurs fois les
 * déclarations de fonctions ou de types contenues dans le fichier.
 *
